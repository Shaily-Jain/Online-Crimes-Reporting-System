...
<head>
    ...
    $conn=mysqli_connect("localhost:3307","root","","crime_portal");
    if(!$conn)
    {
    ...
    $p_id=$_SESSION['pol'];
     $result=mysqli_query($conn,"SELECT c_id,type_crime,d_o_c,location,mob,u_addr FROM complaint natural join user where p_id='$p_id' and pol_status='ChargeSheet Filed' order by c_id asc");
    ?>
