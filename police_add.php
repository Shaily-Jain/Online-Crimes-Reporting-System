...
<head>
    ...
    $con=mysqli_connect('localhost:3307','root','','crime_portal');
    if(!$con)
    {
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2>Log Police Officer</h2></p><br>	
				<form action="#" method="post" style="color: gray">Police Name
                    ...
                    Location of Police Officer<input type="text" required id="location"  name="location" id="<?php echo "$location"; ?>" readonly value="<?php echo "$location"; ?>">
                    <!-- used for adding location manually 
                      Location of Police Officer<input type="text" required id="location"  name="location" placeholder="Location" onfocusout="f1()"/> -->
          <br>
